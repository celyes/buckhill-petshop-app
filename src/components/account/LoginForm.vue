                        ...
                        <DialogPanel
                            ...
                            <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                                <div class="flex items-center">
                                    <div class="mt-3 text-center sm:mt-0 w-full">
                                        ...
                                        <DialogTitle as="h3" class="text-base font-semibold leading-6 text-gray-900">Log
                                            In
                                        </DialogTitle>
                                        <div class="mt-2">
                                            <input
                                            ...
                                            <div class="text-left flex mt-2">
                                                <input
                                                    ...
                                                    class="h-5 w-5"
                                                >
                                                <label for="remember-me" class="text-sm text-gray-500 px-2">Remember
                                                    me</label>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                                <button type="submit"
                                        ...
                                        :class="{'opacity-75': isLoggingIn}"
                                        class="inline w-full justify-center rounded-md bg-green-600 px-3 py-4 text-sm font-semibold text-white shadow-sm hover:bg-green-500 duration-150 "
...
const orderStore: StoreDefinition = useOrderStore()
