...
const navigationMobile = [
  ...
  { name: 'Login', href: 'login', current: false, isRouterLink: true }
]
</script>
<template>
    ...
    <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
      <div class="relative flex h-16 items-center justify-between">
        ...
        <div class="flex flex-1 items-center justify-center md:items-stretch justify-center">
          <div class="md:basis-1/4 xl:basis-1/6 flex flex-shrink-0">
            <h1 class="text-white font-bolder text-2xl justify-center">Petson.</h1>
          </div>
          <div class="md:basis-2/4 xl:basis-2/3 hidden md:mx-6 md:block items-center">
          ...
          <div class="md:basis-1/4 xl:basis-1/6 hidden md:mx-6 md:block">
            <div class="flex space-x-4 justify-center">
              <a href="#"
